...
const Vision = () => {
  return (
    <section className="text-center text-3xl font-semibold font-display bg-white">
      <div className="max-w-[1400px] mx-auto py-20">
        ...
        <p className="text-neutral-900 text-2xl mb-2 font-sans font-regular max-w-5xl mx-auto">
